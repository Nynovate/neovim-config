...
function! s:line(n)
	...
	elseif a:n == 6 " author
		return s:textline("By: " . "rarakoto" . " <" . "rarakoto@student.42antananarivo.mg" . ">", s:ascii(a:n))
	elseif a:n == 8 " created
		return s:textline("Created: " . s:date() . " by " . "rarakoto", s:ascii(a:n))
	elseif a:n == 9 " updated
		return s:textline("Updated: " . s:date() . " by " . "rarakoto", s:ascii(a:n))
	endif
endfunction
...
function! s:mail()
	...
	let l:mail = $MAIL
	if strlen(l:mail) == 0
		let l:mail = "rarakoto@student.42antananarivo.mg"
	endif
	return l:mail
endfunction
